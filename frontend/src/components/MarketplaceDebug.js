...
export default function MarketplaceDebug() {
    ...
    return (
        <div className="glass-panel p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4 text-emerald-200">Marketplace Debug Info</h3>
            ...
            {debugInfo && (
                <div className="space-y-2 text-sm">
                    <div><strong className="text-emerald-300">Timestamp:</strong> {debugInfo.timestamp}</div>
                    <div><strong className="text-emerald-300">Listing Counter:</strong> {debugInfo.listingCounter}</div>
                    <div><strong className="text-emerald-300">Total Volume:</strong> {debugInfo.totalVolume} ETH</div>
                    <div><strong className="text-emerald-300">Total Sales:</strong> {debugInfo.totalSales}</div>
