...
export default function ProfilePage() {
  ...
  const handleList = async (tokenId, price) => {
    try {
      await listNFT(tokenId, price, address);
      handleCloseModal();
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center space-x-6 text-sm text-green-200/60">
                  ...
                  <span>•</span>
                  <span>
                    {creatorProfile?.verified ? "Verified Creator" : "Member"}
                  </span>
                </div>
              </div>
                      ...
                      {ownedNFTs.map((nft) => (
                        ...
                        >
                          {nft.imageUrl ? (
                            ...
                            <div className="w-full h-48 bg-[#0e1518] flex items-center justify-center text-green-200/60">
                              No image
                            </div>
                          )}
                          <div className="p-4">
                  ...
                  <div className="space-y-4">
                    {userListings.length === 0 && userAuctions.length === 0 ? (
                      <div className="text-center py-12">
                        ...
                        <p className="text-green-200/70">
                          Your listings and auctions will appear here
                        </p>
                      </div>
                    ) : (
                      <>
                        {userListings.map((l) => (
                          <div
                            ...
                            className="flex items-center p-4 glass-panel rounded-lg"
                          >
                        ...
                        {userAuctions.map((a) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <p className="text-sm font-medium text-emerald-200">
                                Auctioning NFT #{a.tokenId}
                              </p>
                              <p className="text-sm text-green-200/70">
                                Ends at {new Date(a.endTime).toLocaleString()}
                              </p>
                            </div>
                          </div>
                        ))}
